...
if __name__=='__main__':
    write_off_fault('tpv5', ('-120', '030', '000'), author = "Eric Daub", version = "0.8", grid_spacing = "100 m")
    write_on_fault('tpv5', ('-120', '000'), normal = False, author = "Eric Daub", version = "0.8", grid_spacing = "100 m")
    write_front('tpv5', depthsign = -1., author = "Eric Daub", version = "0.8", grid_spacing = "100 m")
